...
public class CyclicLeverMagazineRetTask extends Procedure{
    ...
    public CyclicLeverMagazineRetTask(Agent agent, RewardValue rewardValue,
    ...
    public Cue[] getCue() {
        if (currentState == State.getState(0))
            ...
            return new Cue[]{Cue.get(CueNames.InsideMagazine)};
